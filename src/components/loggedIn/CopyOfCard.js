...
import { Alert, Text, StyleSheet, Image, View, TouchableOpacity, Easing } from 'react-native';
import Spinner from '../common/Spinner';
import { connect } from 'react-redux';
import {fetchCards} from '../../actions/cards';

const FlipView = require('react-native-flip-view-next');
            ...
            return(
                <View style={styles.mainContainer}>
                    ...
                    <View style={{paddingTop: 40, paddingBottom: 20, justifyContent: 'center', alignItems: 'center'}}>
                        ...
                        <Text style={{fontSize: 21, fontWeight: '500', textAlign: 'center'}}>Your score is: ${this.state.correctAnswers} out of ${this.props.cards.length}</Text>
                    </View>
